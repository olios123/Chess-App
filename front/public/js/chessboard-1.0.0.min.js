...
!(function () {
    ...
    function pe(e) {
        ...
        for (var r, n = (e = e.replace(/ .+$/, "")).split("/"), t = {}, o = 8, a = 0; a < 8; a++) {
            for (var i = n[a].split(""), s = 0, p = 0; p < i.length; p++) {
                ...
                else (t[F[s] + o] = (r = i[p]).toLowerCase() === r ? "b" + r.toUpperCase() : "w" + r.toUpperCase()), (s += 1);
            }
            o -= 1;
        }
        return t;
    ...
    function fe(e) {
        return (
            ...
            (e.hasOwnProperty("pieceTheme") && (re(e.pieceTheme) || ne(e.pieceTheme))) || (e.pieceTheme = "img/chesspieces/wikipedia/{piece}.png"),
        ...
        (window.Chessboard = function (e, f) {
            ...
            function m(e, r, n) {
                if (!0 === f.hasOwnProperty("showErrors") && !1 !== f.showErrors) {
                    ...
                    return "console" === f.showErrors && "object" == typeof console && "function" == typeof console.log
                ...
                r.html(
                    (function (e) {
                        ...
                        for (var o = "white", a = 0; a < 8; a++) {
                            ...
                            for (var i = 0; i < 8; i++) {
                                var s = n[i] + t;
                                (r += '<div class="{square} ' + H[o] + " square-" + s + '" style="width:' + b + "px;height:" + b + 'px;" id="' + g[s] + '" data-square="' + s + '">'),
                                    f.showNotation &&
                                        ((("white" === e && 1 === t) || ("black" === e && 8 === t)) && (r += '<div class="{notation} {alpha}">' + n[i] + "</div>"), 0 === i && (r += '<div class="{notation} {numeric}">' + t + "</div>")),
                                    (r += "</div>"),
                    ...
                    T(),
                    f.sparePieces && ("white" === p ? (t.html(x("black")), o.html(x("white"))) : (t.html(x("white")), o.html(x("black"))));
            }
            function k(e) {
                var r = _(c),
                    n = _(e);
            ...
            function I(e, r, n, t) {
                (ne(f.onDragStart) && !1 === f.onDragStart(e, r, _(c), p)) ||
                    ...
                    a.attr("src", P(r)).css({ display: "", position: "absolute", left: n - b / 2, top: t - b / 2 }),
                    "spare" !== e &&
                        z("#" + g[e])
            ...
            (i.clear = function (e) {
                        ...
                        for (var e = !0, r = {}, n = 0; n < arguments.length; n++)
                            if (!1 !== arguments[n])
                                if (te(arguments[n])) {
                                    ...
                                    r[t[0]] = t[1];
                                } else m(2826, "Invalid move passed to the move method.", arguments[n]);
                            else e = !1;
                        var o = (function (e, r) {
                            var n = _(e);
                            for (var t in r)
                ...
                (i.orientation = function (e) {
                    return 0 === arguments.length
                        ...
                        : void m(5482, "Invalid value passed to the orientation method.", e);
                }),
                (i.position = function (e, r) {
                    if (0 === arguments.length) return _(c);
                    if (re(e) && "fen" === e.toLowerCase()) return ce(c);
                    (re(e) && "start" === e.toLowerCase() && (e = _(G)), ae(e) && (e = pe(e)), ie(e))
                        ? (!1 !== r && (r = !0),
                          r
                              ? ((function (e, r, n) {
                                    if (0 !== e.length)
                                        for (var t = 0, o = 0; o < e.length; o++) {
                                            var a = e[o];
                                            "clear" === a.type
                                                ? z("#" + g[a.square] + " ." + H.piece).fadeOut(f.trashSpeed, i)
                                                : "add" !== a.type || f.sparePieces
                                                ? "add" === a.type && f.sparePieces
                                                    ? S(a.piece, a.square, i)
                                                    : "move" === a.type && O(a.source, a.destination, a.piece, i)
                                                : z("#" + g[a.square])
                                                      .append(y(a.piece, !0))
                                                      .find("." + H.piece)
                                    ...
                                    (function (e, r) {
                                        ...
                                        for (o in r)
                                            if (r.hasOwnProperty(o)) {
                                                var a = ue(e, r[o], o);
                                                a && (n.push({ type: "move", source: a, destination: o, piece: r[o] }), delete e[a], delete r[o], (t[o] = !0));
                                            }
                                        for (o in r) r.hasOwnProperty(o) && (n.push({ type: "add", square: o, piece: r[o] }), delete r[o]);
                                        for (o in e) e.hasOwnProperty(o) && (t.hasOwnProperty(o) || (n.push({ type: "clear", square: o, piece: e[o] }), delete e[o]));
                                        return n;
                                    })(c, e),
                                    c,
                                    e
                ...
                (i.resize = function () {
                    (b = (function () {
                        ...
                        f.sparePieces && n.find("." + H.sparePieces).css("paddingLeft", b + s + "px"),
                        q();
                }),
                (i.start = function (e) {
                    i.position("start", e);
            ...
            return (
                (p = f.orientation),
                f.hasOwnProperty("position") && ("start" === f.position ? (c = _(G)) : ae(f.position) ? (c = pe(f.position)) : ie(f.position) ? (c = _(f.position)) : m(7263, "Invalid value passed to config.position.", f.position)),
                (function () {
                    !(function () {
                        ...
                        (r = n.find("." + H.board)),
                        f.sparePieces && ((t = n.find("." + H.sparePiecesTop)), (o = n.find("." + H.sparePiecesBottom)));
                    var e = Z();
                ...
                (function () {
                    z("body").on("mousedown mousemove", "." + H.piece, j),
                        ...
                        r.on("mouseenter", "." + H.square, $).on("mouseleave", "." + H.square, J);
                    var e = z(window);
                    e.on("mousemove", Y).on("mouseup", L),
                        "ontouchstart" in document.documentElement && (r.on("touchstart", "." + H.square, R), n.on("touchstart", "." + H.sparePieces + " ." + H.piece, X), e.on("touchmove", K).on("touchend", U));
                })(),
                i
            );
        }),
